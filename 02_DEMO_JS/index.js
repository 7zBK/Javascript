...
// const {frist:fristname, last:lastname,location:{district, province} } = person;
...
// const productprice = product.products.data.items[0].price
// console.log(productprice);
const item = product.products.data.items;
for (item of items){
